...
use AdfabCms\Service\Dynablock as AdminDynablockService;
...
protected $options, $blockMapper;
    ...
    public function createAction()
    {
        ...
        $viewModel = new ViewModel();
        $viewModel->setTemplate('adfab-cms/dynablock/dynablock');
    ...
    public function getAdminDynablockService()
    {
        if (!$this->adminDynablockService) {
            $this->adminDynablockService = $this->getServiceLocator()->get('adfabcms_dynablock_service');
        }
