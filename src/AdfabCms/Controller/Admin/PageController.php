...
use AdfabCms\Service\Page as AdminPageService;
...
class PageController extends AbstractActionController
{
    ...
    {
        $form = $this->getServiceLocator()->get('adfabcms_page_form');
        ...
        $viewModel->setTemplate('adfab-cms/page/page');
    ...
    public function removeAction()
    {
        ...
        if ($page) {
            try {
                ...
                $this->flashMessenger()->setNamespace('adfabcms')->addMessage('The page has been deleted');
            } catch (\Doctrine\DBAL\DBALException $e) {
                //$this->flashMessenger()->setNamespace('adfabcms')->addMessage('Il y a déjà eu des participants à ce jeu. Vous ne pouvez plus le supprimer');
                //throw $e;
            }
        }
    ...
    public function getPageMapper()
    {
        if (null === $this->pageMapper) {
            $this->pageMapper = $this->getServiceLocator()->get('adfabcms_page_mapper');
        }
    ...
    public function getAdminPageService()
    {
        if (!$this->adminPageService) {
            $this->adminPageService = $this->getServiceLocator()->get('adfabcms_page_service');
        }
