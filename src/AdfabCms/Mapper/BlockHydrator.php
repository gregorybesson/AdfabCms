...
use AdfabCms\Entity\BlockInterface as BlockEntityInterface;
...
class BlockHydrator extends ClassMethods
{
    ...
    public function extract($object)
    {
        if (!$object instanceof BlockEntityInterface) {
            throw new Exception\InvalidArgumentException('$object must be an instance of AdfabCms\Entity\BlockInterface');
        }
