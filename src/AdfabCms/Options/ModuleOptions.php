...
class ModuleOptions extends AbstractOptions
{
     ...
     * @var string
     */
    protected $dynablockEntityClass = 'AdfabCms\Entity\Dynablock';

    /**
     * @var string
     */
    protected $pageEntityClass = 'AdfabCms\Entity\Page';

    /**
     * @var string
     */
    protected $blockEntityClass = 'AdfabCms\Entity\Block';
     ...
     * @return \AdfabCms\Options\ModuleOptions
     */
