...
use AdfabCms\Mapper\PageInterface as PageMapperInterface;
use AdfabCms\Entity\Page as EntityPage;
...
class Page extends EventProvider implements ServiceManagerAwareInterface
{
     ...
     * getActivePages
     *
     * @return Array of AdfabPage\Entity\Page
     */
    public function getActivePages($displayHome = true, $category = 0)
    {
        ...
        $query = $em->createQuery(
                'SELECT p FROM AdfabCms\Entity\Page p
    ...
    public function getPageMapper()
    {
        if (null === $this->pageMapper) {
            $this->pageMapper = $this->getServiceManager()->get('adfabcms_page_mapper');
        }
